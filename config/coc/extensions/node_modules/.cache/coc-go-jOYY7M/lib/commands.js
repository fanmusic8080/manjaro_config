...
function installGopls(client) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield tools_1.installGoBin(binaries_1.GOPLS, true);
        if (client.needsStop()) {
            yield client.stop();
            yield client.start();
        }
...
function installGomodifytags() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield tools_1.installGoBin(binaries_1.GOMODIFYTAGS, true);
    });
}
exports.installGomodifytags = installGomodifytags;
function installGotests() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield tools_1.installGoBin(binaries_1.GOTESTS, true);
    });
}
